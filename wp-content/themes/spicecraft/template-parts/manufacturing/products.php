<?php
/**
 * Manufacturing Section: Processed Products Connection
 *
 * Connects facility capabilities to relevant WooCommerce spice catalog items
 * or categories in strict catalog mode (no purchase/cart buttons).
 *
 * @package SpiceCraft
 */
...
$prod_sec = function_exists( 'spicecraft_get_manufacturing_section' )
	? spicecraft_get_manufacturing_section( 'products' )
	: array();
...
<section id="sc-mfg-products" class="sc-mfg-products sc-section sc-section--alt" aria-label="<?php echo esc_attr( $heading ); ?>">
