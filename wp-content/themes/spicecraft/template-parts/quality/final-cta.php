<?php
/**
 * Quality & Sourcing Section: Final Contact CTA
 *
...
$fcta = function_exists( 'spicecraft_get_quality_section' )
	? spicecraft_get_quality_section( 'final_cta' )
	: array();
...
<section id="sc-quality-final-cta" class="sc-quality-final-cta sc-section" aria-label="<?php echo esc_attr( $heading ?: __( 'Contact Quality Team', 'spicecraft' ) ); ?>">
	<div class="sc-container sc-container--narrow text-center" style="max-width: 680px; margin: 0 auto;">
		...
		<div class="sc-quality-final-cta__actions" style="display: flex; gap: 14px; justify-content: center; flex-wrap: wrap; margin-top: var(--sc-space-8, 32px);">
			...
			<?php if ( $show_wa && ! empty( $global_wa ) ) :
				...
				$wa_link  = 'https://wa.me/' . $wa_clean . '?text=' . rawurlencode( __( 'Hello SpiceCraft, I would like to connect regarding spice quality and sourcing standards.', 'spicecraft' ) );
				?>
