<?php
/**
 * Quality & Sourcing Section: Certifications & Accreditations
 *
 * Integrates statutory certifications from the spicecraft_certification taxonomy.
 *
 * @package SpiceCraft
 */
...
$cert_sec = function_exists( 'spicecraft_get_quality_section' )
	? spicecraft_get_quality_section( 'certifications' )
	: array();
...
<section id="sc-quality-certifications" class="sc-quality-certs sc-section sc-section--alt" aria-label="<?php echo esc_attr( $heading ?: __( 'Quality Certifications & Accreditations', 'spicecraft' ) ); ?>">
